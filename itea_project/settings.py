"""
Django settings for itea_project project.
...
SECRET_KEY = 'django-insecure-@p%u5ha_@6h0ur*&0)nz0ejnsr3eneyyu%m=edxdaotg^f8(a!'
...
ROOT_URLCONF = 'itea_project.urls'
...
WSGI_APPLICATION = 'itea_project.wsgi.application'
